...
export default function Greetings() {
  ...
  const buttonStyle =
    "bg-medium-blue text-white font-semibold flex justify-around items-center gap-x-2 rounded-lg p-4 hover:underline";
  return (
    <section>
        ...
        <div className="w-full max-w-screen-2xl m-auto shadow-md flex justify-between items-center px-12 h-[80px] bg-light-gradient rounded-lg mt-[-50px] sp-8">
          ...
          <div className="space-x-4 flex font-semibold">
            ...
            <button
              ...
              onClick={()=>router.push("/platform/dashboard/exercises?create_exercise=true")}
            >
